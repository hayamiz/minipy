...
def my_sin_3(x):
    return x - x * x * x / fact(3)

def my_sin_5(x):
    x2 = x * x
    x3 = x * x2
    x5 = x3 * x2
    return x - x3 / fact(3) + x5 / fact(5)
...
def my_sin_9(x):
    ...
    x7 = x5 * x2
    x9 = x7 * x2
    return x - x3 / fact(3) + x5 / fact(5) - x7 / fact(7) + x9 / fact(9)
...
def my_sin_11(x):
    ...
    x9 = x7 * x2
    x11 = x9 * x2
    return x - x3 / fact(3) + x5 / fact(5) - x7 / fact(7) + x9 / fact(9) - x11 / fact(11)
...
def taylor_main():
    ...
    draw_x_axis(Ax, Bx)
    draw_y_axis(Ay, By)
    draw_curve_function(my_sin_1,  Ax + 0.1, Bx - 0.1, 0.01)
    draw_curve_function(my_sin_3,  Ax + 0.1, Bx - 0.1, 0.01)
    draw_curve_function(my_sin_5,  Ax + 0.1, Bx - 0.1, 0.01)
    draw_curve_function(my_sin_7,  Ax + 0.1, Bx - 0.1, 0.01)
    draw_curve_function(my_sin_9,  Ax + 0.1, Bx - 0.1, 0.01)
    draw_curve_function(my_sin_11, Ax + 0.1, Bx - 0.1, 0.01)
    print_showpage()
    print_newline()
